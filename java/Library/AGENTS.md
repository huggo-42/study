# AGENTS.md - Developer Guide for Library

## Project Snapshot

- Spring Boot 3.5.11, Java 17, Maven wrapper (`./mvnw`)
- Minimal app shell with `LibraryApplication` and a simple `Product` model
...
./mvnw test -Dtest=LibraryApplicationTests

# Run a single test method
./mvnw test -Dtest=LibraryApplicationTests#contextLoads
...
- Packages: lower-case (`com.vhuggo42.Library` per current code)
- Classes: `PascalCase` (e.g., `Product`, `LibraryApplication`)
